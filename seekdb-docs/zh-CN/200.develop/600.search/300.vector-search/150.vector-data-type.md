...
* 支持创建稠密/稀疏向量索引，具体请参见[稠密向量索引](200.vector-index/300.dense-vector-index/100.dense-vector-index-overview.md)。
...
* [稠密向量索引](200.vector-index/300.dense-vector-index/100.dense-vector-index-overview.md)
