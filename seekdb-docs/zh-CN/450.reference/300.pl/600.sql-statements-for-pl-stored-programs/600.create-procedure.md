...
要调用存储过程，请使用 `CALL` 语句，详细信息请参见 [CALL](../500.pl-manipulation-statement-mysql/100.call.md)。
...
有关创建存储过程的详细示例信息，请参见 [存储过程](../200.storage-object/300.pl-stored-procedure.md)。
