...
触发器信息也可从 `INFORMATION_SCHEMA TRIGGERS` 表中获得。详细信息请参见 [INFORMATION_SCHEMA TRIGGERS](../800.information-schema-dictionary-view/300.information-schema-triggers.md)。
