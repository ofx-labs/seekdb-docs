...
默认情况下，回收站处于开启状态，该行为由系统变量 `recyclebin` 控制。您可以通过 `SHOW VARIABLES LIKE 'recyclebin'` 查看回收站是否开启。有关系统变量 `recyclebin` 的详细信息，参见 [recyclebin](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000002015995)。
