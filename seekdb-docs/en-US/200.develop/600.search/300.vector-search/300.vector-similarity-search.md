...
* For more information about vector indexes and examples, see [Create vector indexes](200.vector-index/300.dense-vector-index/100.dense-vector-index-overview.md).
